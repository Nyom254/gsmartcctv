        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (lastYear == tahun && lastMonth == bulan && lastInisial == inisial ) {
                    ...
                    noTransaksi = `PO/${inisial}/${tahun}${bulan}/${sequence}`
                }
            }
            if (typeof (noTransaksi) === "string") {
                ...
                document.getElementById("no_transaksi").value = `PO/${inisial}/${tahun}${bulan}/0001`
            }

        }
    }
    xhr.open('GET', './pembelian/purchase-order/data_no-transaksi.php', true)
    xhr.send()
}
