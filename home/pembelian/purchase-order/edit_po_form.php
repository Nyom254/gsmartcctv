...
<?php 
$no_po = $_GET['no'];
$queryPurchaseOrder = mysqli_query($conn, "SELECT * from purcahse_order where no_transaksi = '$no_po'");
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <script>
                                                document.getElementById('jenis_ppn').value = <?php echo $dataPurchaseOrder['JENIS_PPN'] ?>
                                            </script>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group row float-right col-9">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" id="grandtotal" class="form-control form-control-sm" value="<?php echo $dataPurchaseOrder['DPP'] + $dataPurchaseOrder['PPN'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
