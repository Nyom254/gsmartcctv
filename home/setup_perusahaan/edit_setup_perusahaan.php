...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_SESSION['status'])) {
        ...
        if (file_exists($_FILES['logo_perusahaan']['tmp_name']) || is_uploaded_file($_FILES['logo_perusahaan']['tmp_name'])) {
            $queryEditPerusahaan = mysqli_prepare($conn, "update setup_perusahaan set inisial = ?, nama = ?, alamat = ?, kota = ?, provinsi = ?, kode_pos = ?, no_telp = ?, no_rek = ?, logo_perusahaan = ?, kode_departemen = ? where id = ?");
            mysqli_stmt_bind_param($queryEditPerusahaan, "sssssissssi", $inisial, $nama, $alamat, $kota, $provinsi, $kode_pos, $no_telp, $no_rek, $logo_perusahaan, $kode_departemen, $id);
            ...
            if ($_FILES['logo_perusahaan']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array($mimeType, $mimeTypes)) {
                    ...
                    if ($kode_departemen !== $rowDataPerusahaanLama['kode_departemen']) {
                        $editedBarang[] = "nomor rekening perusahaan dari " . $rowDataPerusahaanLama['no_rek'] . " menjadi $no_rek";
                    }
            ...
            $queryEditPerusahaan = mysqli_prepare($conn, "update setup_perusahaan set inisial = ?, nama = ?, alamat = ?, kota = ?, provinsi = ?, kode_pos = ?, no_telp = ?, no_rek = ?, kode_departemen = ? where id = ?");
            mysqli_stmt_bind_param($queryEditPerusahaan, "sssssisssi", $inisial, $nama, $alamat, $kota, $provinsi, $kode_pos, $no_telp, $no_rek, $kode_departemen, $id);
